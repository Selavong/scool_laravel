                                    ...
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar avatar-sm flex-shrink-0">
                                                <img class="avatar-img rounded-circle" alt="User Image" src="{{ URL::to('assets/img/favicon.png') }}">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">Director</span> has
                                                    approved <span class="noti-title">your proposal</span></p>
                                        ...
                                        <div class="media d-flex">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details">
                                                    <span class="noti-title">Principal</span> has sent you a invoice 
                                ...
                                {{-- <li class="notification-message">
                                    <a href="#">
                                        <div class="media d-flex">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">SETEC</span> sent a cancellation request <span class="noti-title">Apple iPhone XR</span></p>
